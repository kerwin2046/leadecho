...
type Querier interface {
	...
	CompleteWorkspaceSetup(ctx context.Context, id string) (Workspace, error)
	...
	CountKeywordsByProfile(ctx context.Context, arg CountKeywordsByProfileParams) (int32, error)
	...
	DeleteKeywordByProfile(ctx context.Context, arg DeleteKeywordByProfileParams) error
	...
	GetAgentStats(ctx context.Context, arg GetAgentStatsParams) (GetAgentStatsRow, error)
	...
	ListAgents(ctx context.Context, workspaceID string) ([]ListAgentsRow, error)
	...
	ListInvitationsByWorkspace(ctx context.Context, workspaceID string) ([]Invitation, error)
	ListKeywords(ctx context.Context, workspaceID string) ([]ListKeywordsRow, error)
	ListKeywordsByProfile(ctx context.Context, arg ListKeywordsByProfileParams) ([]ListKeywordsByProfileRow, error)
	...
	ListUnclassifiedMentions(ctx context.Context, arg ListUnclassifiedMentionsParams) ([]ListUnclassifiedMentionsRow, error)
	...
	TouchAgentRun(ctx context.Context, arg TouchAgentRunParams) (MonitoringProfile, error)
	...
	UpdateAgentStatus(ctx context.Context, arg UpdateAgentStatusParams) (MonitoringProfile, error)
	...
	UpdateMentionScoring(ctx context.Context, arg UpdateMentionScoringParams) error
